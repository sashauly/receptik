export const en = {
  ...
  home: {
    ...
    searchPlaceholder: "Search recipes by name or tag...",
    allRecipes: "All",
  },
  recipe: {
  ...
  modals: {
    ...
    deleteRecipeConfirm: "Are you sure you want to delete this recipe? This action cannot be undone.",
    shareRecipe: "Share Recipe",
    shareRecipeDesc: "Share with friends and family",
  },
  share: {
    link: "Link",
    social: "Social",
